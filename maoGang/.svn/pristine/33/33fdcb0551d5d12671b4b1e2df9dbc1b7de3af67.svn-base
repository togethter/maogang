...
- (void)textDidChange
{
    if ([self.xdelegate respondsToSelector:@selector(IWTextViewDelegateTextChangeAction:count:withTextView:)]) {
        [self.xdelegate IWTextViewDelegateTextChangeAction:self.text count:self.text.length withTextView:self];
    }

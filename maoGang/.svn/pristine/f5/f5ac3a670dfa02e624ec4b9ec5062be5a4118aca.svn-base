...
-(void) initCommon
{
    ...
    self.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, _containerView.bounds.size.height);
...
- (void)createGIF {
        ...
        self.loadingImageView.frame = CGRectMake(0, 0, 150, 80);

...
//生成字帖
//token        是    [string]
//2    content    内容    是    [string]
//3    poetryId    诗词编号    是    [string]
//4    poetryContentId    内容编号    是    [string]
//5    typefaceId    字体编号    是    [string]
//6    wordLattice    字格    是    [string]
//7    WordColour    字格颜色    是    [string]
//8    Transparency    透明度    是    [string]
//9    FontSize    字号    是    [string]
//10    Typesetting    排版    是    [string]
//11    FullScreen    满屏    是    [string]
//12    PaperType    纸张    是    [string]
//13    Punctuation    标点符号    是    [string]
#define CopybookCreate [NSString stringWithFormat:@"%@%@",KUser2,@"Copybook/Create"]
...
//升级
#define UpdateIOS [NSString stringWithFormat:@"%@%@",@"http://chat1.chongfa.cn/api/",@"system/updateIos"]

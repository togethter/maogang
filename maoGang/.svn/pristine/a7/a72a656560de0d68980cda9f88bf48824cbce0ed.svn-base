...
@interface YLMyFansOfViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger _page;
}
...
@implementation YLMyFansOfViewController
-(UITableView *)tableV{
...
-(void)downLoad{
    ...
    [self netWorkHelperWithPOST:MyMyFans parameters:@{@"token":TOKEN,@"page":@(_page)} success:^(id responseObject) {

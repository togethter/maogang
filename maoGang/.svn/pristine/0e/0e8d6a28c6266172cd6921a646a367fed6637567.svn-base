//
//  YLFocusonWorksViewController.m
//  maoGang
//
...
@interface YLFocusonWorksViewController ()
<
CircleUserCellDelegate,
XLScrollowContainCommentViewDelegate,
LikeUserTableViewCelldelegate,
UITableViewDelegate,
...
@implementation YLFocusonWorksViewController
...
-(void)downLoad{
    ...
    if (!TOKEN) {
        ...
        [GiFHUD show:@"请登录~" view:self.view];
        return;
    }else{
        toekn = TOKEN;
    }
    [self netWorkHelperWithPOST:PostesMyFollows parameters:@{@"page":@(_page),@"token":toekn} success:^(id responseObject) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (self.dataMuArr.count>indexPath.section) {

//
//  XLRemotoNotificationWebViewController.m
//  LvJie
//
//  Created by bilin on 2018/2/27.
//  Copyright © 2018年 Bilin-Apple. All rights reserved.
//

#import "XLRemotoNotificationWebViewController.h"

@interface XLRemotoNotificationWebViewController ()
@property (nonatomic, assign) NSUInteger loadCount;

@end

@implementation XLRemotoNotificationWebViewController
...
- (void)viewDidLoad {
    ...
    [self addLeftItemAction:@selector(leftItem)];

...
- (void)longGesture:(UILongPressGestureRecognizer *)gesture{
    if (gesture.state == UIGestureRecognizerStateBegan) {
        ...
        if (self.callbackStateBegan){
            self.callbackStateBegan(nil);
        }else if ([self.photoScrollViewDelegate respondsToSelector:@selector(pickerPhotoScrollViewDidSingleClickStateBegan:)]) {
            [self.photoScrollViewDelegate pickerPhotoScrollViewDidSingleClickStateBegan:self];
        }
//        if (!self.sheet) {

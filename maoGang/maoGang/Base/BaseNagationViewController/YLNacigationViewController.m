//
//  YLNacigationViewController.m
//  LeForProject
//
//  Created by zhangzhen on 2018/6/19.
...
#define The_MainColor BXColor(255, 255, 255)
// 设置颜色
...
@interface YLNacigationViewController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
@implementation YLNacigationViewController
...
//    UIImage * backButtonImage = [[UIImage imageNamed:@"btn_fanhui"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 30, 0, 0)];
...
//    [[UIBarButtonItem appearance]setBackButtonTitlePositionAdjustment:UIOffsetMake(NSIntegerMin, NSIntegerMin) forBarMetrics:UIBarMetricsDefault];
    ...
    _screenshotImgView.frame = CGRectMake(0, 0,kScreenWidth , kScreenHeight);
    _screenshotImgView.userInteractionEnabled = YES;
...
- (void)dragging:(UIPanGestureRecognizer *)pan
{
    ...
    if (offsetX < kScreenWidth) {
        ...
        _screenshotImgView.transform = CGAffineTransformMakeTranslation((offsetX - kScreenWidth) * 0.6, 0);
    }
...
{   isCanGesture
    ...
    if (translateX <= 40) {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            _screenshotImgView.transform = CGAffineTransformMakeTranslation(-kScreenWidth, 0);
...
//            YLRootViewController *jRootViewVC =  self.viewControllers.lastObject;
//            if ([jRootViewVC isKindOfClass:[YLRootViewController class]]) {
//                if (IS_VALID_STRING(jRootViewVC.scriptMessageName)) {// 如果存在就去移除它
//                    [jRootViewVC.wkuserConentVC removeScriptMessageHandlerForName:jRootViewVC.scriptMessageName];
//                }
//            }
//

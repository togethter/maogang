...
//        bgView.userInteractionEnabled = NO;//  tab_iconIrregular
//        bgView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"tabs_Irregular_2"]];
...
- (void)layoutSubviews {
    ...
    self.imageView.y = self.titleLabel.y - self.imageView.height-6 ;
